...
public enum MemberErrorCode {
    ...
    NICKNAME_OVER_LENGTH(HttpStatus.BAD_REQUEST, "닉네임이 12자 초과입니다"),
    NICKNAME_SPACE_EXIST(HttpStatus.BAD_REQUEST, "닉네임에 공백이 있습니다"),
    NICKNAME_SYMBOL_EXIST(HttpStatus.BAD_REQUEST, "닉네임에 특수문자가 있습니다");
